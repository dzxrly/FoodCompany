...
public class CustomerUpdate {
    public void updateCustomer(int number, String personalName, String companyName, Integer type, Integer level, String address, String email, String phoneNumber) {
